...
export default function AdminSupport() {
  ...
  const fetch_ = () => {
    setLoading(true);
    fetch(API_BASE_URL + '/api/support', { headers: { Authorization: `Bearer ${token}` } })
  ...
  const del = async (id) => {
    ...
    await fetch(API_BASE_URL + `/api/support/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
    fetch_();
  };
