...
export default function AdminInspections() {
  ...
  const fetch_ = () => {
    setLoading(true);
    fetch(API_BASE_URL + '/api/inspections', { headers: { Authorization: `Bearer ${token}` } })
  ...
  const del = async (id) => {
    ...
    await fetch(API_BASE_URL + `/api/inspections/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
    fetch_();
  };
